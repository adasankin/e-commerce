														...
														<form method="POST" enctype="multipart/form-data">
															<table class="table">
																<tr>
																	...
																	<td><input type="text" name="first_name" class="form-control" required placeholder="Nama Depan"></td>
																</tr>
																<tr>
																	<td width=20%>Nama Belakang</td>
																	<td><input type="text" name="last_name" class="form-control" required placeholder="Nama Belakang"></td>
																</tr>
																<tr>
