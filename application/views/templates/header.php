...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Galdeano&family=Gelasio:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&family=Inknut+Antiqua:wght@300;400;500;600;700;800;900&family=Inter:wght@100;200;300;400;500;600;700;800;900&family=Karantina:wght@300;400;700&family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&family=Lobster&family=Rubik:ital,wght@0,300..900;1,300..900&display=swap" rel="stylesheet">
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="row">
                                        <div class="col-auto">
                                            <a href="<?= base_url() ?>" class="logo__link"><img src="<?= assetsPath("img/logo.png") ?>" alt="company logo" width="100"></a>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="input-group">
                                                            <input list="searchList" class="form-control" placeholder="What are you looking for ?" />
                                                            <a href="<?= base_url('products/') ?>" class="btn btn-outline-secondary">
                                                                <svg class="menu__icon__logo" width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <script>
                                                                document.querySelector('input').addEventListener('input', function() {
                                                                    ...
                                                                    var options = document.querySelectorAll('datalist')[0].options;
                                                                    for (var i = 0; i < options.length; i++) {
                                                                        if (options[i].value === value) {
                                                                            window.location.href = "<?= base_url('product/') ?>" + options[i].dataset.id;
                                                                        }
                                                                    }
                                                                });
                                                            </script>
                                ...
                                <div class="col-auto d-flex justify-content-center align-items-center gap-3">
                                    <?php if (!is_login() || (is_login() && is_admin())) { ?>
                                        <a href="<?= is_login() ? (is_admin() ? base_url('admin') : '#') : base_url('register') ?>" class="person__link">
                                            <svg class="menu__icon__logo" width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <?php } ?>
                                    <?php if (is_login()) { ?>
                                        <a href="<?= base_url('cart') ?>" class="busket__link">
                                            <svg class="menu__icon__logo" width="32" height="29" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="<?= base_url('logout') ?>" class="logout__link">
                                            <i class="menu__icon__logo fa-solid fa-right-from-bracket fs-2" style="color: #E8E8E8"></i>
                                        </a>
                                    <?php } ?>
                                </div>
                            </div>
                ...
                <div class="col-auto text-center">
                    <?php if (is_login()) { ?>
                        <!-- <h2 class="text-white me-1"><?= $this->user->me()->f_name ?></h2> -->
                    <?php } ?>
                </div>
            </div>
        </div>
